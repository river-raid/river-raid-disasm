...
@ $670A label=handle_up
  $6712 Set CONTROLS_BIT_SPEED_ALTERED
  $6714,2 Reset CONTROLS_BIT_SPEED_DECREASED
@ $6717 label=handle_down
  $671F Set CONTROLS_BIT_SPEED_ALTERED
...
@ $6A60 label=locate_level_terrain
  ...
  $6A64 Next row
  $6A6D If it's the last row, advance to the next bridge
...
@ $6AAF label=locate_terrain_row_sprite
  ...
  $6AB3 Next byte
  $6ABA If it's the last byte, advance to the next row.
  $6ABF Point #REGhl to byte of the current terrain row defined by #R$5F7D.
  ...
  $6ACA Jump to handling special cases.
...
R $6E9C I:BC Pointer to the fragment to explode.
  $6E9F Set CONTROLS_BIT_EXPLODING
...
c $708E
  $713E Sprite frame size (3×1 tiles × 8 bytes/tile)
...
c $74EE
  $7520,2 POINTS_TANK
  $7529 Set CONTROLS_BIT_BONUS_LIFE
